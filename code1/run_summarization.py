...
# Test GPU device
print("WaterFriend: Testing GPU device...")
...
tf.app.flags.DEFINE_integer('vocab_size', 20000, 'Size of vocabulary. These will be read from the vocabulary file in order. If the vocabulary file contains fewer words than this number, or if this number is set to 0, will take all words in the vocabulary file.') #originally 20000
...
def main(unused_argv):
    ...
    if hps_generator.mode.value == 'train':
        ...
        print("Start pre-training......the first stage")
        print("waterfriend 0")
        sc_model = Sc_Generator(hps_sc_generator, vocab)    #sc_model is a mamber of "Sc_Generator" class
        ...
        run_pre_train_sc_generator(sc_model, sc_batcher, 1, sess_sc, saver_sc, train_dir_sc, sc_generated)  #originally 40
        ...
        print("Start pre-training......the second stage")
        ...
        print("Start pre-training generator......")
        run_pre_train_generator(model, batcher, 1, sess_ge, saver_ge, train_dir_ge, generated) #originally 30
        ##################################################################################################
        ...
        print("Start pre-training srl_generator......the third stage")
        run_pre_train_srl_generator(srl_generator_model, batcher,srl_batcher, 1, sess_srl_ge, saver_srl_ge, train_dir_srl_ge, srl_generated, whole_generated)  #originally 20
        ...
        for epoch in range(10):
            ...
            for i in range(min(len(batches), len(srl_batches))):
                ...
                if train_step % 100 == 0:
                    ...
                    tf.logging.info('loss: %f', loss_window / 100)  # print the loss to screen
                    loss_window = 0.0
                print("waterfriend 14")
                
                train_srl_step = results_srl['global_step']
                print("waterfriend 15")
                ...
                print("waterfriend 16")

            sc_generated.generator_max_example_test(sc_batcher.get_batches("pre-train"),

                                                    "data/" + str(
                                                        0) + "/train_skeleton.txt")
            print("waterfriend 17")

            sc_generated.generator_max_example_test(sc_batcher.get_batches("pre-valid"),

                                                    "data/" + str(
                                                        0) + "/valid_skeleton.txt")
            print("waterfriend 18")

            sc_generated.generator_max_example_test(sc_batcher.get_batches("pre-test"),

                                                    "data/" + str(
                                                        0) + "/test_skeleton.txt")
            print("waterfriend 19")
        ...
        Errmessage = "The 'mode' flag must be one of train/eval/decode, now the mode is: %s" %(hps_generator.mode.value)
